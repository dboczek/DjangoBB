...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('djangobb_forum_category', 'site',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('djangobb_forum_category', 'site_id')
    ...
    models = {
        ...
        'djangobb_forum.ban': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ban'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        ...
        'djangobb_forum.reputation': {
            ...
            'reason': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'blank': 'True'}),
